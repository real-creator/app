...
public class GalleryViewPager1 extends ViewPager {
    private DisplayMetrics displayMetrics;

    public GalleryViewPager1(Context context) {
        super(context);
        init();
    }

    public GalleryViewPager1(Context context, AttributeSet attributeSet) {
